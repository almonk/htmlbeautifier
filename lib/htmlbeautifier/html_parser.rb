...
module HtmlBeautifier
  class HtmlParser < Parser
    ...
    HTML_BLOCK_ELEMENTS = %r{(?:
      ...
      pre | section | table | tbody | td | tfoot | th | thead | tr | ul | video | avalon-button | avalon-icon | avalon-input | avalon-message | avalon-modal | avalon-page-header | avalon-popover | avalon-slide-panel
    )}mix
